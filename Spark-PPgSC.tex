...
\newcommand{\Mtitulo}{SparkSQL Development Issues}
...
\begin{document}
   ...
   % Epigrafe (arquivo Includes/Epigrafe.tex)
	...
	\include{Parts/2-Background}
	\include{Parts/3-Proposal}
	
	% Capitulo 4: Quarto capítulo (arquivo Includes/Capitulo4.tex)
	%\include{Parts/Capitulo4}
	
	% Capitulo 5: Quinto capítulo (arquivo Includes/Capitulo5.tex)
	%\include{Parts/Capitulo5}
		
	% Consideracoes finais
	%\include{Parts/Consideracoes}
	...
	%\include{Parts/ApendiceA}
	
	% Anexo A (arquivo Includes/AnexoA)
	%\include{Parts/AnexoA}
